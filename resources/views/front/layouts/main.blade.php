...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="{{route('front-home')}}"><strong id="siteName">BITC-WAY</strong></a>
...
{{--                        <a class="nav-link dropdown-toggle txtWhitecolor" href="{{route('user-wallets')}}" id="navbarDropdown" role="button"--}}
...
{{--                    </li>--}}
                        <li class="nav-item">
                            <a class="txtWhitecolor nav-link" href="{{route('user-wallets')}}"><i id="userIcon" class="fas fa-user"></i>  {{Auth::user()->first_name.' '.Auth::user()->last_name}}</a>
                        </li>
                    <?php }else{?>
                    <li class="nav-item">
