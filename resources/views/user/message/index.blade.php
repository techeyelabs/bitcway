...
<div class="w3-modal-content w3-card-4 w3-animate-zoom" id="div" style="max-width:600px; margin: auto;">
    <div id="wrap" class="message">
        <h3 class="txtHeadingColor msgHeader pageTitle">{{__('title22')}}</h3>
            ...
            <div class="card-body">
                <form action="#" v-on:submit="send">
                    <div class="input-group">
                            ...
                            <br><br>
                            <button  class="btn btn-outline-warning mt-2" type="submit" :disabled="message == ''" style="margin: auto;">{{__('BUTTON2')}}</button>
                    </div>
                </form>
            </div>
        </div>
