<!-- Site footer -->
<!-- Site footer -->
{{-- <footer class="site-footer" style="background-color: #081420">--}}
{{--        <div class="container">--}}
{{--            <div class="row">--}}
...
{{--                    <p class="copyright-text txtWhitecolor">Copyright &copy; 2018 All Rights Reserved by--}}
{{--                        <a href="#" class="txtWhitecolor">BITC-WAY</a>.--}}
{{--                    </p>--}}
{{--                </div>--}}
