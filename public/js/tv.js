    ...
    if (!window.TradingView || !window.TradingView.host || window.TradingView.reoloadTvjs) {
        var e, t, i, o, n, r, s, a = {
            ...
            embedStylesForFullHeight: function (e, t, i) {
                var o = t ? "calc(" + e + " - 32px)" : e, n = document.querySelector("#" + i);
            ...
            hasCopyright: function (e) {
                var t = document.getElementById(e), i = t && t.parentElement;
                return !!i && !!i.querySelector(".tradingview-widget-copyright")
            },
            calculateWidgetHeight: function (e, t) {
                var i = parseInt(e), o = this.getSuffix(e), n = this.isPersentHeight(o), r = t && this.hasCopyright(t);
            ...
            css: function (e) {
                var t, i = document.getElementsByTagName("head")[0], o = document.createElement("style");
            ...
            widget: function (e) {
                ...
                var t = d.getUrlParams(),
                    i = e.tvwidgetsymbol || t.tvwidgetsymbol || t.symbol || e.symbol || "NASDAQ:AAPL", o = e.logo || "";
            ...
            QuotesProvider: function (e) {
                ...
                function r(e) {
                    var o = e.symbol, n = e.success, r = e.error;
                    o && n && r && (i.post(t.contentWindow, "resolveSymbol", {symbol: o}), n && i.on("success" + o, (function (e) {
                        n(e)
        ...
        d.DependenciesManager = function () {
        }, d.DependenciesManager.prototype.scripts = {}, d.DependenciesManager.prototype._loaded = function (e) {
            ...
            fixSize: function (e) {
                ...
                var o = d.WidgetAbstract.prototype.height.call(this), n = d.WidgetAbstract.prototype.width.call(this);
                i = i || "transparent";
                ...
                var i = (t || {}).greyText || "powered by", o = (t || {}).linkText || "tradingview.com",
            ...
            createWidget: function () {
                ...
                var e = this.options.room ? "#" + encodeURIComponent(this.options.room) : "",
                    ...
                    i = d.generateUtmForUrlParams(this.options, {type: "UserInfoWidget"});
            ...
            createWidget: function () {
                var e = this.widgetCode();
                l(e, this.options.container);
                var t = this, i = document.getElementById(this.id);
                ...
                var t = "&" + d.generateUtmForUrlParams(this.options), i = d.ideasHost + "/idea-popup/?" + e + t;
            ...
            createWidget: function () {
                ...
                var e = this.options, t = d.createUrlParams({
                    id: this.id,
                    width: e.width,
                    height: e.height,
                    symbol: e.symbol,
                    ...
                    locale: e.locale,
                    useWidgetHost: Boolean(e.useWidgetHost)
                }), i = d.generateUtmForUrlParams(this.options) + "&", o = d.getHost(e) + "/ideaswidgetembed/?" + i + t;
            ...
            createWidget: function () {
                var e = this.widgetCode(), t = this.options;
                if (!t.noLogoOverlay && !t.whitelabel) {
                    var i = this.options.greyText || "Quotes by";
                    e = d.WidgetAbstract.prototype.addFooterLogo.call(this, e, {greyText: i, linkText: "TradingView"})
                }
                l(e, t.container)
            }, widgetCode: function () {
                var e = "", t = "", i = "", o = "/miniwidgetembed/",
                ...
                var y = function (e) {
                    for (var t = [], o = 0; o < e.length; o++) {
                        var n = e[o];
                        if (d.isArray(n)) {
                            var r = encodeURIComponent(n[0]), s = encodeURIComponent(n[1]);
                            t.push(r), i += "&" + r + "=" + s
                ...
                if (this.options.symbols_description) for (var b in this.options.symbols_description) i += "&" + encodeURIComponent(b) + "=" + encodeURIComponent(this.options.symbols_description[b]);
            ...
            createWidget: function () {
                ...
                var e = "", t = "symbols=" + function (t) {
                        ...
                        return i.join(",")
                    }(this.options.symbols), i = "&width=" + encodeURIComponent(this.options.width),
            ...
            create: function () {
                ...
                i && i.parentElement && i.parentElement.removeChild(i), this.iframe = document.getElementById(this.id), this.postMessage = d.postMessageWrapper(this.iframe.contentWindow, this.id), d.bindEvent(this.iframe, "load", (function () {
                    ...
                    var a = t.options.popup_width || 900, l = t.options.popup_height || 600, h = (screen.width - a) / 2,
                        c = (screen.height - l) / 2,
                ...
                var e = document.getElementById(this.id), t = e.parentNode;
                t.removeChild(e), t.innerHTML = this.render()
            }
        }, d.chart.prototype = {
            create: function () {
                this.isMobile = d.isMobileDevice.any;
                var e, t = this.render(), i = this;
                d.chartCssAttached || (d.css(this.renderCss()), d.chartCssAttached = !0), l(t, this.options.container), e = document.getElementById(this.id), d.bindEvent(e, "load", (function () {
                    ...
                    var t = !1;
                    if (document.querySelector && document.querySelector('a[href$="/v/' + i.options.chart + '/"]') && (t = !0), !t) for (var o = document.getElementsByTagName("a"), n = new RegExp("/v/" + i.options.chart + "/$"), r = new RegExp("/chart/([0-9a-zA-Z:+*-/()]+)/" + i.options.chart), s = 0; s < o.length; s++) if (n.test(o[s].href) || r.test(o[s].href)) {
                        t = !0;
                        break
                    }
            ...
            }, ready: d.widget.prototype.ready, renderCss: function () {
            ...
            d.dependenciesManager.depends(["/static/bundles/spinner.js"], "authWidget", (function () {
                ...
                var n = d.gId(), r = d.createUrlParams({id: n, utmSourceOverride: e.utmSourceOverride}),
                    s = d.getHost(e) + "/authwidget/?" + r, a = "650px",
                ...
                var c = document.getElementById(n), p = d.postMessageWrapper(c.contentWindow, n), g = function (e) {
            ...
            var i = d.gId(), o = d.createUrlParams({id: i}), n = d.ideasHost + "/isauthwidget/?" + o,
            ...
            var a = document.getElementById(i), l = d.postMessageWrapper(a.contentWindow, i), h = function (e) {
                e.id === i && (document.body.removeChild(s), t(e.user), l.off("close", h))
            };
            l.on("close", h, !0)
        }, d.onLoginStateChange = function (e, t) {
            var i = d.gId(), o = d.createUrlParams({id: i}), n = d.ideasHost + "/loginstatewidget/?" + o,
                r = '<iframe id="' + i + '" src="' + n + '" frameborder="0" allowTransparency="true" scrolling="no"></iframe>',
                s = document.createElement("div");
            s.innerHTML = r, document.body.appendChild(s);
            ...
            if (n && n.provider && "TradingView" === n.provider) if (n.source = e.source, "get" === n.type) {
                if (!o[n.name]) return;
            ...
            } else if ("on" === n.type) i[n.client_id] && i[n.client_id][n.id] && (i[n.client_id][n.id].call(n, n.data), delete i[n.client_id][n.id]); else if ("post" === n.type) {
                if (!o[n.name]) return;
                o[n.name].forEach((function (e) {
            ...
            return i[a] = {}, n[a] = e, t = e, {
                on: function (e, t, i) {
                    ...
                    var o = {id: s++, type: "post", name: t, data: i, provider: "TradingView"};
